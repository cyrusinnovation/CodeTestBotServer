...
describe AssessmentsController do
  ...
  describe '#index' do
    ...
    let(:submission1json) { {email_text: 'first', zipfile: nil, active: true, candidate_name: nil, candidate_email: nil, level_id: nil, language_id: nil} }
    let(:submission2json) { {email_text: 'second', zipfile: nil, active: true, candidate_name: nil, candidate_email: nil, level_id: nil, language_id: nil} }
